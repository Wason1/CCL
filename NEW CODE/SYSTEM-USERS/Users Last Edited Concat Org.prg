SELECT ;DISTINCT	; USER EXTRACT SCRIPT	
    ...
    , ORGANISTION = listagg( substring(5,5,ORG.ORG_NAME)  ,", ") over (partition by P.USERNAME order by ORG.ORG_NAME) ;Listagg	
...
JOIN	ORG_S	
JOIN	CRED
JOIN    P_CRED  where P_CRED.NAME_FULL_FORMATTED not like  "CERNER, CERNER"
