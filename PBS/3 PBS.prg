...
from	(		
	...
	;and	drug_orig.end_effective_dt_tm = cnvtdatetime("31-MAY-2016 23:59:59")	
	and	exists (select 1	
	...
	and	drug_new.beg_effective_dt_tm != cnvtdatetime(curdate, 0003)	; exclude already updated rows
