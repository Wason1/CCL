...
;and	o.synonym_id  in ()	
and	(	
	o.iv_set_synonym_id > 0	; order set order
	or	
	o.synonym_id  in (select synonym_id from order_catalog_synonym where mnemonic_type_cd = 614543)	; "E - IV Fluids and Nicknames' from code set 6011
	)	
;and	o.med_order_type_cd in (10912, 10914)	; 'Intermittent' and 'IV' from code set 18309. Using this returns Y and Z synonyms, that are normally excluded.
join	p_o	
join	p_o_stat	
join	e_orig	
join	ea_URN	
...
;and	o_a.updt_dt_tm between cnvtdatetime("24-MAR-2021") and cnvtdatetime("25-MAR-2021")	; between dates
join	p_o_a	
join	p	
join	ocs	
;join	e_curr	
